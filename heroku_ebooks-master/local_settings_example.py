...
MY_CONSUMER_KEY = 'Het56KNoyS5DvB2DHkYqcjQxG'
MY_CONSUMER_SECRET = ' wCJ7bS1mHLDHn1gJTySehZhwikeRWZ7nyx9Zm8V08at5c9Kgls'
MY_ACCESS_TOKEN_KEY = '880837225403088896-QxL7po1VZGlfg4QAvDFKUAw6sZaw1Pg'
MY_ACCESS_TOKEN_SECRET = '8YFvtex3ga8Xgg2TzpBxpGRyGUAwGeQLUm7MVE06f0T1k'
...
SOURCE_ACCOUNTS = ["garyfromteenmom","DolanDark","whiteandfaded","potatophilips"]  # A list of comma-separated, quote-enclosed Twitter handles of account that you'll generate tweets based on. It should look like ["account1", "account2"]. If you want just one account, no comma needed.
...
TWEET_ACCOUNT = "itgregfromwork"  # The name of the account you're tweeting to.
